...
// faiss::IndexHNSWFlat* centroid_index = dynamic_cast<faiss::IndexHNSWFlat*>(faiss::read_index("centroid_index"));
    // search function for a subset of queries
     auto sub_search_func = [this, k, nprobe, params](
    // auto sub_search_func = [this, k, nprobe, params, centroid_index](
                                   idx_t n,
                                   const float* x,
                                   float* distances,
                                   idx_t* labels,
        ...
        indexIVFPQDisk_stats.nprobeSearch_time+=duration1.count();
...
struct IVFPQDiskScanner : IVFPQDiskScannerT<idx_t, METRIC_TYPE, PQDecoder>,
    ...
    size_t scan_codes(
        ...
        if (this->polysemous_ht > 0) {
            ...
            indexIVFPQDisk_stats.PQScan_time += duration.count();
        ...
        if(real_heap != 0){
            ...
            if(this->load_strategy == FULLY){
             ...
             auto end1 = std::chrono::high_resolution_clock::now();
                std::chrono::duration<double> duration1 = end1 - start1;
                indexIVFPQDisk_stats.full_cluster_time += duration1.count();
            }else{
            ...
            auto end2 = std::chrono::high_resolution_clock::now();
                ...
                indexIVFPQDisk_stats.partial_cluster_time += duration2.count();
            }
