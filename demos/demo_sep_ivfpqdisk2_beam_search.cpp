...
void disk_build(const char* base_filepath, int nb, int d, int ratio, 
    ...
    faiss::IndexIVFPQDisk2 index(&quantizer, d, nlist, m, nbits, top_clusters, estimate_factor, prune_factor, index_store_path);
...
void search(const char* query_filepath, const char* ground_truth_filepath, 
    ...
    float estimate_factor = 1.3;
    float estimate_factor_partial = 1.05;
    float estimate_factor_high_dim = 1.1;
    float prune_factor =100.0;
    ...
    //int arr[] = {120, 140, 160, 180, 200};
    //int arr[] = {100};
    //int arr[] = {80};

    std::cout << "Warming up disk index: " <<std::endl;

    index->warm_up_nlist(100, xq, 20, 0);
    //index->warm_up_nvec(100, xq, 20, 50);

    index->warm_up_index_info(1000, xq, 40, 8000);
...
int main(int argc, char *argv[]) {
    ...
    int ratio = 10;   // ratio for training
    ...
    const char* base_filepath = "/mnt/d/VectorDB/GIST1M/gist/gist_base.fvecs";
    const char* query_filepath = "/mnt/d/VectorDB/GIST1M/gist/gist_query.fvecs";
    const char* ground_truth_filepath = "/mnt/d/VectorDB/GIST1M/gist/gist_groundtruth.ivecs";
    // data
    
    // index like pq.. parameters..
    // std::string index_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_pd2_list16k";
    // std::string disk_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_ivfpqdisk_pd2_list16k.index";
    // std::string centroid_index_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_pd2_centroid_hnsw_list16k";
    //std::string disk_store_path = "/home/granthe/faiss/faiss/build/data/sift1M/sift1M_ivfpqdisk.index";

    // std::string index_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_pd2_list8k";
    // std::string disk_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_ivfpqdisk_pd2_list8k.index";
    // std::string centroid_index_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_pd2_centroid_hnsw_list8k";


    // std::string index_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_pd2_list8k_greedybuild";
    // std::string disk_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_ivfpqdisk_pd2_list8k_greedybuild.index";
    // std::string centroid_index_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_pd2_centroid_hnsw_list8k_greedybuild";

    // std::string index_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_toy_greedybuild";
    // std::string disk_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_ivfpqdisk_ptoy_greedybuild.index";
    // std::string centroid_index_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_pd2_centroid_hnsw_toy_greedybuild";

    // std::string index_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_list8k_pq168_greedybuild_slmode_test4build";
    // std::string disk_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_ivfpqdisk_list8k_pq168_greedybuild_slmode_test4build.index";
    // std::string centroid_index_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_pd2_centroid_hnsw_list8k_pq168_greedybuild_slmode_test4build";

    std::string index_store_path =    "/home/granthe/ivfpq_test_data/gist1M/gist1M_r2_list8k_pq1208";
    std::string disk_store_path =     "/home/granthe/ivfpq_test_data/gist1M/gist1M_r2_ivfpqdisk_list8k_pq1208.index";
    std::string centroid_index_path = "/home/granthe/ivfpq_test_data/gist1M/gist1M_r2_centroid_hnsw_list8k_pq1208";
    // centroid hnsw
