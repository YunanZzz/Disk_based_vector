...
void search(const char* query_filepath, const char* ground_truth_filepath, 
    ...
    float estimate_factor_partial = 1.03;
    float prune_factor =10.0;
    ...
    for (int i : arr) {
        ...
        size_t sl  = faiss::indexIVFPQDisk2_stats.pruned;
...
int main(int argc, char *argv[]) {
    ...
    std::string index_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_list8k_pq168_greedybuild_slmode";
    std::string disk_store_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_ivfpqdisk_list8k_pq168_greedybuild_slmode.index";
    std::string centroid_index_path = "/home/granthe/ivfpq_test_data/sift1M/sift1M_pd2_centroid_hnsw_list8k_pq168_greedybuild_slmode";
