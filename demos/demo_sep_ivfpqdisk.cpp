...
void disk_build(
    ...
    index.set_replicas_control(1.2);
    srand(static_cast<int>(time(0)));
    std::vector<float> trainvecs(nb / ratio * d);
...
void search(
    ...
    int arr[] = {40, 60, 80, 100, 120, 140, 160, 180, 200, 260, 280,320};
    // int arr[] = {20, 30, 40, 60, 80, 100, 120, 140, 160, 180, 200, 240, 260, 280, 300};
    // int arr[]={440};
    for (int i : arr) {
        ...
        double fc = faiss::indexIVFPQDisk_stats.PQ_four_code.count();
        double fc1 = faiss::indexIVFPQDisk_stats.PQ_four_code1.count();
        double fc2 = faiss::indexIVFPQDisk_stats.PQ_four_code2.count();
        ...
        std::cout << "memory_1_elapsed    :" << m1t/ 1e6 << std::endl;
        std::cout << "memory_2_elapsed :" << m2t/ 1e6 << std::endl;
        std::cout << "disk_full_elapsed    :" << ft/ 1e6 << std::endl;
        std::cout << "disk_partial_elapsed :" << pt/ 1e6 << std::endl;
        std::cout << "rank_elapsed    :" << rt/ 1e6 << std::endl;
        std::cout << "coarse_elapsed    :" << nt/ 1e6 << std::endl;
        std::cout << "others_elapsed    :" << pqt/ 1e6 << std::endl;
        std::cout << "PQ_four_code_elapsed    :" << fc/ 1e6 << std::endl;
        std::cout << "PQ_four_code1_elapsed    :" << fc1/ 1e6 << std::endl;
        std::cout << "PQ_four_code2_elapsed    :" << fc2/ 1e6 << std::endl;
...
int main(int argc, char* argv[]) {
    ...
    std::string index_store_path =
            "/home/zhan4404/disk-based/disk_test/faiss4_disk_vector/build/demos/index_folder/sift10m/sift10m.index";
    std::string disk_store_path =
            "/home/zhan4404/disk-based/disk_test/faiss4_disk_vector/build/demos/index_folder/sift10m/sift10m_ivfpqdisk.index";
