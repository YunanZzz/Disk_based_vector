...
void search(const char* query_filepath, const char* ground_truth_filepath, 
    ...
    float estimate_factor = 1.2;
    float estimate_factor_partial =1.2;
...
int main(int argc, char *argv[]) {
    ...
    std::string index_store_path =    "/home/granthe/ivfpq_test_data/sift10M/sift10M_r1_list40k_pq168_uint8_greedybuild_slmode";
    std::string disk_store_path =     "/home/granthe/ivfpq_test_data/sift10M/sift10M_r1_ivfpqdisk_list40k_pq168_uint8_greedybuild_slmode.index";
    std::string centroid_index_path = "/home/granthe/ivfpq_test_data/sift10M/sift10M_r1_centroid_hnsw_list40k_pq168_uint8_greedybuild_slmode";
    // centroid hnsw
