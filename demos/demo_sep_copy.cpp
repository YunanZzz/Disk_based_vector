...
void search(const char* query_filepath, const char* ground_truth_filepath, int nq, int d, int k, const std::string& disk_store_path) {
    ...
    int arr[] = {20, 25, 30, 35, 40, 60, 80, 100, 120, 140, 160};
    ...
    for (int i : arr) {
        ...
        double ft = faiss::indexIVFPQDisk_stats.full_cluster_time;
        double pt = faiss::indexIVFPQDisk_stats.partial_cluster_time;
        double pqt = faiss::indexIVFPQDisk_stats.PQScan_time;
        double nt = faiss::indexIVFPQDisk_stats.nprobeSearch_time;
        ...
        std::cout << "nprobeSearch_time    :" << nt << std::endl;
        std::cout << "PQscan_time    :" << pqt << std::endl;
        std::cout << "full_cluster_time    :" << ft << std::endl;
        std::cout << "partial_cluster_time :" << pt << std::endl;
